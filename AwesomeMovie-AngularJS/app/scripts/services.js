...
.factory('moviesFactory', ['$resource', 'baseURL', function($resource,baseURL) {
    ...
    return $resource(baseURL + "movies/:id", null, {
        'update': {
            method: 'PUT'
        }
    });
...
.factory('reviewFactory', ['$resource', 'baseURL', function ($resource, baseURL) {
    ...
    return $resource(baseURL + "movies/:id/reviews/:reviewId", {id:"@Id", reviewId: "@ReviewId"}, {
        'update': {
            method: 'PUT'
        }
    });
...
.factory('subscriptionsFactory', ['$resource', 'baseURL', function($resource,baseURL) {
    
    return $resource(baseURL+"subscriptions/:id",null, {
        'update':{
            method:'PUT' 
        }
    });
...
.factory('ticketsFactory', ['$resource', 'baseURL', function ($resource, baseURL) {
       
    return $resource(baseURL + "tickets/:id", null, {
        'update': {
            method: 'PUT'
        },
        'query':  {method:'GET', isArray:false}
